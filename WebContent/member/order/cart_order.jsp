		...
		<div class="container">
			<table border=1 style="font-size: 10pt; font-family: 맑은 고딕; width: 850px">
				...
				<tr>
					...
					<td bgcolor="#eeeede" height="30" align="center">
						<a href="cart_delete.jsp?t_id=<%=t_id%>">
			...
			<form name="form" method="Post" action="cart_order_ok.jsp">
				...
				<table>
					<tr>
						...
						<td>
							<input class="btn btn-success" type=button value="주문확인" OnClick="check_val()">
						</td>
						<td>
							<input class="btn btn-danger" type="reset" value="주문취소" name="reset">
						</td>
					</tr>
				</table>
