...
<body>
	...
	try {
		...
		String jsql = "INSERT INTO qna_answer (qna_ref_no, m_id, qna_comment_date, qna_comment, manager_id) VALUES  (?, ?, ?, ?, ?)";

		PreparedStatement pstmt = con.prepareStatement(jsql);

		pstmt.setInt(1, qna_ref_no);
		pstmt.setString(2, qna_answer_m_id);
		pstmt.setString(3, qna_comment_date);
		pstmt.setString(4, qna_comment);
		pstmt.setString(5, manager_id);
